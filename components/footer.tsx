          ...
          <div className="flex items-center gap-4 mb-8">
            {socialLinks.map((link) => (
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-secondary text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
              >
                <link.icon />
              </a>
            ))}
