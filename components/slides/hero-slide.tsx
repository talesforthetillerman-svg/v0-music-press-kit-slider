  ...
  return (
    <section className="relative flex h-full w-full shrink-0 snap-start items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-12 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold tracking-tight text-foreground mb-2 text-balance">
          Tales for the
          <br />
          Tillerman
        </h1>
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-md mt-4 md:mt-8 leading-relaxed">
